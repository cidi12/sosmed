...
class DashboardController extends Controller
{
    ...
    {
        $post = Post::select('id', 'user_id', 'username', 'post_title', 'post_content', 'post_commenter', 'post_comment', 'total_comment', 'likes', 'dislikes', 'shares')->inRandomOrder()->limit(5)->get();
